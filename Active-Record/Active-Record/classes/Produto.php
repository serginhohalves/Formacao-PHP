...
// Row Data Gateway: responsável pelo o transporte de dados vindo diretamente do 
...
class Produto
{
    ...
    // public function alterarProduto($preco,$quantidade)
    // {
    //     $this->preco_venda = $preco;
    //     $this->estoque += $quantidade;
    // }

    // public function AumentarEstoque($estoque)
    // {
    //     $this->estoque += $estoque;
    // }

    // public function DiminuirEstoque($estoque)
    // {
    //     $this->estoque -= $estoque;
    // }
}

// Armazenamento de dados de maneira externa --> Table data Gateway
// Armazenamento de dados de maneira interna --> Row data Gateway
// Armazenamento de dados de maneira interna + métodos de regra de negócio --> Active Record
